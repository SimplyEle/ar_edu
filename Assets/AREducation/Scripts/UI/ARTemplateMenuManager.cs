...
public class ARTemplateMenuManager : MonoBehaviour
{
    ...
    void DeleteFocusedObject()
    {
        ...
        {
            currentFocusedObject.transform.gameObject.GetPhotonView().RPC("DeleteOnAllClients", RpcTarget.AllViaServer, currentFocusedObject.transform.gameObject.GetPhotonView().ViewID);
        }
    }
