...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            trackables.AddComponent<PhotonView>();
        }
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            EnsureFacingCamera();
            var photonView = newObject.GetComponent<PhotonView>();
            var syncController = newObject.GetComponent<ObjectSyncController>();
            syncController.Initialize(newObject.GetPhotonView().ViewID, photonView.ViewID, PhotonNetwork.LocalPlayer.ActorNumber, spawnPoint);
